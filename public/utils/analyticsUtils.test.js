...
var _analyticsUtils = require("./analyticsUtils");
describe('getAnalyticsData', function () {
  ...
  test('should calculate analytics data correctly with debt adjustments', function () {
    var result = (0, _analyticsUtils.getAnalyticsData)(mockDebts, 'month', mockAdjustments);
  ...
  test('should handle empty adjustments', function () {
    var result = (0, _analyticsUtils.getAnalyticsData)(mockDebts, 'month', []);
