...
var getApiBaseUrl = function getApiBaseUrl() {
  ...
  var backendPort = import.meta.env.VITE_BACKEND_PORT || 5002;
  return "http://localhost:".concat(backendPort, "/api");
};
var apiBaseUrl = getApiBaseUrl();
var apiFetch = exports.apiFetch = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(endpoint) {
    var options,
      url,
      response,
      _args = arguments,
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          url = "".concat(apiBaseUrl).concat(endpoint);
          _context.p = 1;
          _context.n = 2;
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          console.error("API error ".concat(endpoint, ":"), _t);
          throw _t;
        case 4:
          return _context.a(2);
      }
