...
exports.BranchCreateModal = BranchCreateModal;
...
function BranchCreateModal(_ref) {
  ...
  var _useBranches = (0, _BranchContext.useBranches)(),
    createBranch = _useBranches.createBranch,
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 5:
            _context.p = 5;
            _t = _context.v;
            console.error('Error creating branch:', _t);
          case 6:
            _context.p = 6;
            setIsSubmitting(false);
            return _context.f(6);
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, "Yangi filial yaratish"), /*#__PURE__*/_react["default"].createElement("button", {
    onClick: onClose,
  ...
  })))), !canCreateBranch && /*#__PURE__*/_react["default"].createElement("div", {
    className: "p-3 sm:p-4 mx-4 sm:mx-6 mt-3 sm:mt-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg"
  }, /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, "Filiallar soni chegarasi"), /*#__PURE__*/_react["default"].createElement("p", {
    className: "text-sm text-yellow-700 dark:text-yellow-300 mt-1"
  }, "Sizning tarifingizda faqat ", branchLimit, " ta filial yaratish mumkin. Hozir ", branches.length, "/", branchLimit, " filial ishlatilmoqda."), /*#__PURE__*/_react["default"].createElement("button", {
    className: "text-sm text-yellow-800 dark:text-yellow-200 underline mt-2 hover:no-underline"
  }, "Tarifni yangilash")))), /*#__PURE__*/_react["default"].createElement("form", {
    ...
    className: "block text-sm font-medium mb-3 ".concat(settings.theme === 'dark' ? 'text-gray-200' : 'text-gray-700')
  }, "Ko'rinish"), /*#__PURE__*/_react["default"].createElement("div", {
    className: "p-3 sm:p-4 rounded-lg border-2 border-dashed ".concat(settings.theme === 'dark' ? 'border-gray-600 bg-gray-700/30' : 'border-gray-300 bg-gray-50')
  }, /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, getBranchIcon(formData.icon)), /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("h3", {
    className: "font-semibold ".concat(settings.theme === 'dark' ? 'text-white' : 'text-gray-900')
  }, formData.name || 'Filial nomi'), /*#__PURE__*/_react["default"].createElement("p", {
    className: "text-sm ".concat(settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-500')
  }, formData.description || 'Filial tavsifi'))))))), /*#__PURE__*/_react["default"].createElement("div", {
    className: "flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700 mt-4 sm:mt-6"
    ...
    className: "flex-1 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors text-sm sm:text-base ".concat(!canCreateBranch || isSubmitting || loading ? 'bg-gray-400 cursor-not-allowed text-white' : 'bg-blue-600 hover:bg-blue-700 text-white')
  }, isSubmitting || loading ? /*#__PURE__*/_react["default"].createElement("div", {
    className: "flex items-center justify-center space-x-2"
  }, /*#__PURE__*/_react["default"].createElement("div", {
    className: "w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"
  }), /*#__PURE__*/_react["default"].createElement("span", null, "Yaratilmoqda...")) : 'Filial yaratish')))));
}