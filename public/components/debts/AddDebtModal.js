...
exports.AddDebtModal = AddDebtModal;
...
function AddDebtModal(_ref) {
  ...
  var _useState = (0, _react.useState)({
      ...
      currency: (activeBranch === null || activeBranch === void 0 ? void 0 : activeBranch.currency) || currency || 'UZS'
    }),
    _useState2 = _slicedToArray(_useState, 2),
    newDebt = _useState2[0],
    setNewDebt = _useState2[1];

  // Update currency when active branch changes
  (0, _react.useEffect)(function () {
    if (activeBranch !== null && activeBranch !== void 0 && activeBranch.currency) {
      setNewDebt(function (prev) {
  ...
  var handleAmountChange = function handleAmountChange(e) {
    ...
    setNewDebt(_objectSpread(_objectSpread({}, newDebt), {}, {
  ...
  var handlePhoneChange = function handlePhoneChange(e) {
    var inputValue = e.target.value;
    var currentCountryCode = newDebt.countryCode;
  ...
  var handleCountryCodeChange = function handleCountryCodeChange(code) {
    setNewDebt(_objectSpread(_objectSpread({}, newDebt), {}, {
      countryCode: code,
      phone: ''
    }));
  };
  var handleCurrencyChange = function handleCurrencyChange(curr) {
    setNewDebt(_objectSpread(_objectSpread({}, newDebt), {}, {
      currency: curr
    }));
  };
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 1:
            ...
            debtData = _objectSpread({}, newDebt); // Close modal immediately for better UX
            onClose();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "relative bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 p-2.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 bg-gradient-to-r from-green-400/20 via-emerald-400/20 to-teal-400/20 backdrop-blur-sm"
  }), /*#__PURE__*/React.createElement("div", {
    className: "relative flex justify-between items-center"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-xl font-bold text-white mb-1"
  }, t('debts.form.addDebt', 'Yangi qarz qo\'shish')), /*#__PURE__*/React.createElement("p", {
    className: "text-white/80 text-xs"
  }, "Qarz ma'lumotlarini to'ldiring")), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
  ...
  })), t('debts.form.creditor', 'Kreditor nomi'), " ", /*#__PURE__*/React.createElement("span", {
    ...
    onChange: function onChange(e) {
      return setNewDebt(_objectSpread(_objectSpread({}, newDebt), {}, {
  ...
  }, newDebt.currency))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement("svg", {
  ...
  })), t('debts.form.debtDate', 'Qarz sanasi'))), /*#__PURE__*/React.createElement("input", {
    type: "date",
    value: newDebt.debtDate,
    onChange: function onChange(e) {
      return setNewDebt(_objectSpread(_objectSpread({}, newDebt), {}, {
        debtDate: e.target.value
      }));
    },
    className: "w-full p-2.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm text-gray-800 dark:text-white font-medium focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-300 hover:border-green-400 text-sm"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    ...
    strokeWidth: 2,
    d: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"
  })), t('debts.form.currency', 'Valyuta'))), /*#__PURE__*/React.createElement("select", {
    ...
    value: "UZS"
  }, t('common.uzs', "UZS - O'zbek so'm")), /*#__PURE__*/React.createElement("option", {
    value: "USD"
  }, t('common.usd', 'USD - Dollar')), /*#__PURE__*/React.createElement("option", {
    value: "EUR"
  }, t('common.eur', 'EUR - Yevro')), /*#__PURE__*/React.createElement("option", {
    value: "RUB"
  }, t('common.rub', 'RUB - Rubl')), /*#__PURE__*/React.createElement("option", {
    value: "TJS"
  }, t('common.tjs', 'TJS - Tojik somoni'))))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement("svg", {
  ...
  })), t('debts.form.description', 'Izoh'), /*#__PURE__*/React.createElement("span", {
    className: "text-gray-400 text-xs"
