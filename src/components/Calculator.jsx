...
export function QarzdaftarCalculator() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {/* Main layout with history on left and calculator on right */}
      <div className="flex flex-col lg:flex-row gap-6">
        {/* History Panel - Left side */}
        <div className={`lg:w-1/3 rounded-2xl p-6 shadow-xl ${
          isDarkMode 
        ...
        <div className={`lg:w-2/3 rounded-2xl p-6 shadow-xl ${
          isDarkMode 
            ? 'bg-gray-800/30 border border-gray-700' 
            : 'bg-white/30 border border-white/20'
        }`}>
          ...
          <div className="grid grid-cols-4 gap-2">
            ...
            <button
              onClick={() => handleSidebarCalculatorOperation('=')}
              className={`col-span-4 p-3 rounded-lg font-semibold transition-all ${
                isDarkMode 
