...
export function BranchCreateModal({ isOpen, onClose, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className={`w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl ${settings.theme === 'dark'
        ...
        {!canCreateBranch && (
          <div className="p-4 mx-6 mt-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className={`w-full px-4 py-3 rounded-lg border transition-colors ${errors.description
                    ? 'border-red-500 focus:ring-red-500'
                    : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent ${settings.theme === 'dark'
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-5 gap-3">
                  {BRANCH_COLORS.map(color => (
                    <button
                      ...
                      className={`w-12 h-12 rounded-lg transition-all duration-200 ${formData.color === color
                ...
                <div className="grid grid-cols-3 gap-3">
                  {BRANCH_ICONS.map(icon => (
                    <button
                      ...
                      className={`flex flex-col items-center space-y-2 p-3 rounded-lg border-2 transition-all duration-200 ${formData.icon === icon.name
              ...
              <div>
                ...
                <div className={`p-4 rounded-lg border-2 border-dashed ${settings.theme === 'dark' ? 'border-gray-600 bg-gray-700/30' : 'border-gray-300 bg-gray-50'
                  }`}>
          ...
          <div className="flex space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700 mt-6">
            <button
              type="button"
              onClick={onClose}
              className={`flex-1 px-4 py-3 rounded-lg font-medium transition-colors ${settings.theme === 'dark'
            ...
            <button
              ...
              className={`flex-1 px-4 py-3 rounded-lg font-medium transition-colors ${!canCreateBranch || isSubmitting || loading
